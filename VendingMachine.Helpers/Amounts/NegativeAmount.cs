...
namespace VendingMachine.Helpers.Amounts
{
	...
	/// Can be zero.
	/// </summary>
	[JsonConverter(typeof(NegativeAmountJsonConverter))]
	...
	internal class NegativeAmountJsonConverter : JsonConverter
	{
		public override void WriteJson(JsonWriter writer, object value, JsonSerializer serializer)
		{
			var amount = (NegativeAmount)value;
		...
		{
			return objectType == typeof(NegativeAmount);
		}
	}
}
