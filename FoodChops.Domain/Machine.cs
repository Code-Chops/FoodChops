...
public record MachineTheme : MagicStringEnum<MachineTheme>
{
	public static MachineTheme New { get; }		= CreateMember();
	public static MachineTheme Blue { get; }	= CreateMember();
	public static MachineTheme Red { get; }		= CreateMember();
}
...
public class Machine
{
	...
	/// </summary>
	public MachineTheme Theme { get; }

	public Machine(IReadOnlyList<ProductStack> productStacks, int horizontalProductStackCount, Wallet availableCoinsWallet, Wallet userInsertedCoinsWallet, MachineTheme theme)
	{
